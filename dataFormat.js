// THIS IS HOW THE DATA SHOULD BE FORMATED
...
[
  ...
  },
  {
    ...
    primaryKey: 2,
    name:
      "MIRA SAFETY Hazmat Suit Disposable Protective Coverall NFPA certified with Respirator-Fit Hood and Elastic Cuff Size (LG/XL)",
    price: "129.95",
    stock: 8,
    group: "Wardrobe"
  },
  ...
  },
  {
    ...
    primaryKey: 8,
    name:
      "SOG Fixed Blade Knives with Sheath - SEAL Team Survival Knife, Tactical Knife & Hunting Knife w/ 7 Inch AUS-8 Bowie Knife Half Serrated Edge (S37-K)",
    price: "115.17",
    stock: 6,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 12,
    name:
      "PREPARED4X Emergency Blanket Poncho - Keeps You and Your Gear Dry and Warm During Camping Hiking or Any Outdoor Activity | Thermal Mylar Space Blanket Ponchos to Keep You Prepared to Survive | 3 Pack",
    price: "15.95",
    stock: 3,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 39,
    name:
      "Under the Weather XLPod 1-Person Pop-up Weather Pod. The Original, Patented WeatherPod",
    price: "129.99",
    stock: 6,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 49,
    name:
      "HotHands Toe & Hand Warmer Pack (10 Toe Warmers and 2 packs of Hand Warmers)",
    price: "14.99",
    stock: 9,
    group: "Health"
  },
  ...
  },
  {
    ...
    primaryKey: 52,
    name:
      "REEHUT Ultralight Portable Camping Stoves Backpacking Stove with Piezo Ignition Adjustable Valve",
    price: "14.99",
    stock: 5,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 64,
    name:
      "Wouxun KG-UV8E Tri-Band 136-174/220-260/400-520MHz Cross Band Repeater Duplex Work Mode 999CH VOX SOS CTCSS/DCS Ham Two Way Radio",
    price: "145.88",
    stock: 6,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 75,
    name:
      "Tough Tesla Lighter – Outdoor Waterproof Windproof Dual Arc Plasma USB Electric w/Paratinder Lanyard & Emergency Whistle by Frog & Co. (Orange)",
    price: "14.93",
    stock: 8,
    group: "Outdoors"
  },
  {
    ...
    primaryKey: 76,
    name:
      "Phone Skope PYRO Putty Winter, Summer, Eco Blend, Emergency Survival Fire Starter",
    price: "12.99",
    stock: 10,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 86,
    name:
      "MOSSY OAK Emergency Survival Kit in Waterproof and Airproof Protective Case",
    price: "49.99",
    stock: 6,
    group: "Outdoors"
  },
  {
    ...
    primaryKey: 92,
    name:
      "Geiger Counter Terra-P, Dosimeter Radiometer Radiation Detector MKS-05 IP30",
    price: "194.99",
    stock: 6,
    group: "Outdoors"
  },
  ...
  },
  {
    ...
    primaryKey: 88,
    name:
      "HiCool Winter Gloves,Touch Screen Running Thermal Driving Warm Outdoor Sports Head Gloves for Men Women",
    price: "15.95",
    stock: 19,
    group: "Wardrobe"
  },
  ...
  },
  {
    ...
    primaryKey: 91,
    name:
      "RADEX RD1503+ w/o dosimeter: High Accuracy Geiger Counter, Radiation Detector (English) (4-Pack)",
    price: "2636.94",
    stock: 8,
    group: "Outdoors"
  },
  {
    ...
    primaryKey: 93,
    name:
      "IOSAT - Pack of 3 by Iosat - Thyroid blocking pills for blocking radiation absorption ",
    price: "22.29",
    stock: 16,
    group: "Health"
  },
